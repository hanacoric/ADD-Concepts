    ...
    <section class="section-wrapper">
        ...
        <div class="text-container">
            ...
            <div class="text-container-bottom">
                <p>AD Designs worked with the owners of this beautiful Arts and Crafts house on the design for extension and remodelling of existing garages and their conversion into habitable area. AD Designs secured approval from Hampstead Garden Suburb Trust and planning permission, and subsequently assisted the client in executing the designs on site. </p>
            </div>
