    ...
    <section class="section-wrapper">
        <div class="container">
            <div class="Kensington-Church">
                <h1>Kensington Church Street </h1>
            </div>
        </div>
        ...
        <div class="text-container">
            ...
            <div class="text-container-bottom">
                <p>Remodelling of a period house in Kensington creating a separate studio on the ground floor, improved ceiling heights throughout and complete new interior design. Further projects include Merton House in Highgate, Hendale Avenue in Hendon, Woodstock Avenue in Golders Green, Fortress Avenue in Kentish Town, Arlington Road in Camden Town etc. </p>
            </div>
