    ...
    <section class="section-wrapper">
        ...
        <div class="text-container">
            ...
            <div class="text-container-bottom">
                <p>New basement and roof extension to a Victorian terraced house in Ladbroke Conservation Area, together with internal alterations and refurbishment.  </p>
            </div>
