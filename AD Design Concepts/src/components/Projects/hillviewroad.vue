    ...
    <section class="section-wrapper">
        ...
        <div class="text-container">
            ...
            <div class="text-container-bottom">
                <p>AD Designs designed and secured planning consent for two new build five bedrooms detached houses on the site previously occupied by a small bungalow, adjacent to the Green Belt. We led the project through all stages of work, including landscape and interior design and supervised the construction process to completion.   </p>
            </div>
...
function switchImages(){
  ...
  const imageArray = ["/src/assets/hillviewroadimg/image1.jpg", "/src/assets/hillviewroadimg/image2.jpg" ];
