    ...
    <section class="section-wrapper">
        <div class="container">
            <div class="Oakhill-Avenue">
                <h1> Oakhill Avenue, Hampstead   </h1>
            </div>
        </div>
        ...
        <div class="text-container">
            ...
            <div class="text-container-bottom">
                <p>AD Designs secured planning consent for demolition of the existing house and erection of new apartment block containing 5 apartments and underground car parking. The total area of the approved development was in the region of 21,000 sq. ft. </p>
            </div>
        ...
        <div class="image-container">
            <div class="image">
               <img src="../../assets/images/10a Okhill Avenue - Existing and Proposed Elevations A.jpg" alt="Oakhill-Avenue">
            </div>
        </div>
    </section>
</template>
