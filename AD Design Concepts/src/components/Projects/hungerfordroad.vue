    ...
    <section class="section-wrapper">
        <div class="container">
            <div class="Hungerford-Road">
                <h1>Hungerford Road, Islington  </h1>
            </div>
        </div>
        ...
        <div class="text-container">
            ...
            <div class="text-container-bottom">
                <p>AD Designs services on this project covered all stages of the work, from inception to completion. With the client we created a new build block of flats containing 9 apartments over 4 levels. The building was designed to recreate the features and appearance of previously demolished pair of townhouses.   </p>
            </div>
